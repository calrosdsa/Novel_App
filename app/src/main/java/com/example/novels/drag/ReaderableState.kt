package com.example.novels.drag
...
//                Log.d("REORDER", "old${old.size} new ${new.size}")
    ...
    internal open fun onDragStart(offsetX: Int, offsetY: Int): Boolean {
        return visibleItemsInfo
            ...
            ?.also {
                Log.d("REORDER",it.itemIndex.toString())
                selected = it
...
//        Log.d("REORDER", "y$offsetY x $offsetX")
        val selected = selected ?: return
//        Log.d("REORDER", "select ${selected.itemIndex}")
//        Log.d("REORDER", "bottom ${selected.bottom}")
//        Log.d("REORDER", "right ${selected.right}")
//        Log.d("REORDER", "left ${selected.left}")
//        Log.d("REORDER", "top ${selected.top}")
        ...
        chooseDropItem(
            ...
            Log.d("REORDER", "target ${targetItem.itemIndex}")
    ...
    companion object {
        private const val ACCELERATION_LIMIT_TIME_MS: Long = 100
